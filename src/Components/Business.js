...
class Business extends Component {
  ...
  render() {
    ...
    <div className="box_general">
        <h3>Apply for starting business</h3>
        <p>
      ...
      <div>
        ...
        <div className="row">
          ...
          <div className="col-md-6 col-sm-6">
            <div className="form-group">
              <input type="text" name="EmiratesID" placeholder="Emirates ID" onChange={this.onChange} />
            </div>
          </div>
          <div className="col-md-6 col-sm-6">
            <div className="form-group">
              <input type="text" name="BusinessDescription" placeholder="Business Description" onChange={this.onChange} />
            </div>
          </div>
