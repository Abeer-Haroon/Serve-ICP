...
class ReportingEmergencies extends Component {
  ...
  render() {
    ...
    <div className="box_general">
        <h3>Report Emergency in your Area</h3>
        <p>
      ...
      <div >
        ...
        <input type="submit" value="Google Maps" className="btn_1 add_top_20" id="submit-contact" onClick={this.register} />
        <br/>
        <br/>
...
export default ReportingEmergencies
